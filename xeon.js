...
//© 2022 chami Bot Inc.CHAMI-OFFICIAL-WA-BOT 
//Thank you to Lord Buddha, Family and Myself
//════════════════════════════//
// owenr by CHAMI-OFFICIAL-WA-BOT
//════════════════════════════//
...
let buttonMessage = {
    image: { url: 'https://i.ibb.co/RTxSZM3/R.png'},
caption: xeonbody,
...
XeonBotInc.sendMessage(anu.id, buttonMessage)
    ...
    XeonBotInc.ev.on('connection.update', async (update) => {
        ...
        let reason = new Boom(lastDisconnect?.error)?.output.statusCode
            if (reason === DisconnectReason.badSession) { console.log(`Bad Session File, Please Delete Session and Re Scan`); XeonBotInc.logout(); }
            ...
            else if (reason === DisconnectReason.loggedOut) { console.log(`🦄Device Logged Out, Please Re Again And Run.`); XeonBotInc.logout(); }
